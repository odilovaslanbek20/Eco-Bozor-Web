...
function Menubar2() {
	...
	return (
		<section className='bg-[rgba(26,26,26,1)]'>
			<div className='max-w-[1320px] flex items-center gap-[25px] max-[600px]:py-[20px] m-auto max-[1360px]:mx-[20px]'>
				<div className='min-w-[312px] cursor-pointer h-full max-[600px]:hidden bg-[rgba(51,51,51,1)] flex items-center'>
				...
				<nav className='flex items-center justify-between w-full'>
					<FaBars
						...
						className='text-[25px] text-[#d5d5d5] min-[1010px]:hidden'
					/>
					<div
						className={`${
					...
					>
						...
						<Link
							to='/about'
							className='text-[14px] font-medium font-["Poppins"] text-[#d5d5d5]'
						>
							About Us
						</Link>
						<Link
					...
					<div className='flex items-center gap-[24px]'>
							<IoHeartOutline className='text-[#fff] text-[30px] cursor-pointer' />
							<HiOutlineShoppingBag className='text-[#fff] text-[30px] cursor-pointer' />
						<Link to="/register">
							<FaRegUser className='text-[#fff] text-[25px] cursor-pointer' />
						</Link>
					</div>
				</nav>
			</div>
