		...
		<section className='bg-[#fffefe]'>
			<div className='max-w-[1320px] m-auto max-[1360px]:mx-[20px] py-[24px]'>
				<nav className='flex items-center justify-between'>
					<FaBars onClick={() => setMenu(true)} className='text-[20px] text-[#444444] min-[680px]:hidden' />
						 ...
						 <FaXmark onClick={() => setMenu(false)} className='text-[25px] max-[680px]:top-[15px] max-[680px]:right-[18px] max-[680px]:absolute text-[#d5d5d5] min-[680px]:hidden'/>
							{['Home', 'Shop', 'Page', 'Blog'].map((menu, i) => (
								<div className='relative' key={i}>
									...
									>
										<span className='text-[14px] font-medium font-["Poppins"] text-[#444444] max-[680px]:text-[#d5d5d5]'>
											{menu}
										</span>
										<IoMdArrowDropdown
											className={`${
												activeDropdown === menu ? 'rotate-[180deg]' : 'rotate-0'
											} text-[#040404] max-[680px]:text-[#d5d5d5] transition-all text-[20px]`}
										/>
									</div>
							...
							<Link to="/about" className='text-[14px] font-medium max-[680px]:text-[#d5d5d5] font-["Poppins"] text-[#444444]'>
								About Us
							</Link>
							<Link to="/contact" className='text-[14px] font-medium max-[680px]:text-[#d5d5d5] font-["Poppins"] text-[#444444]'>
								Contact
							</Link>
						</div>

					<div className='flex items-center gap-[3px]'>
						<FiPhoneCall className='text-[18px] text-[#444444]' />
						<a
							className='text-[#444444] text-[14px] font-["Poppins"] font-medium'
