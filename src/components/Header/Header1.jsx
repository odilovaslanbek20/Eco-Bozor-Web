...
function Header1() {
	...
	return (
		<>
			<section className='w-full bg-[rgba(51,51,51,1)]'>
				<div className='max-w-[1320px] m-auto max-[1360px]:mx-[20px] py-[12px] flex items-center justify-between max-[630px]:flex-col max-[630px]:gap-[5px]'>
					<div className=''>
						<div className='flex items-center gap-[2px]'>
							<CiLocationOn className='text-[18px] text-[rgba(179,179,179,1)]' />
							<p className='text-[12px] text-[rgba(179,179,179,1)] font-normal font-["Poppins"]'>
             ...
             <hr className='h-[20px] w-[1px] bg-[#cbcaca]'/>
						...
						<div className="">
							<div className="flex items-center gap-[5px]">
								<Link to="/login" className='font-["Poppins"] text-[12px] font-normal text-[rgba(179,179,179,1)]'>Sign In</Link>
								<div className='bg-[rgba(102,102,102,1)] w-[1px] h-[16px] rotate-[20deg] text-[12px] font-normal font-["Poppins"]'></div>
								<Link to="/register" className='font-["Poppins"] text-[12px] font-normal text-[rgba(179,179,179,1)]'>Sign Up</Link>
							</div>
						</div>
