...
function Hot() {
	return (
		<>
			<section className='w-full py-[60px] mt-[60px] bg-[rgba(247,247,247,1)]'>
				<div className='max-w-[1320px] m-auto max-[1360px]:mx-[20px] mb-[50px] '>
					...
					<div className='grid grid-cols-5 max-[1011px]:grid-cols-4 max-[840px]:grid-cols-3 max-[650px]:grid-cols-2 max-[450px]:grid-cols-1'>
						<div className='group col-span-2 row-span-2 max-[450px]:col-span-1 hover:border-[rgba(44,116,47,1)] hover:shadow-[0px_0px_12px_0px_rgba(32,181,38,0.32)] transition-all cursor-pointer bg-white border border-[rgba(230,230,230,1)] flex flex-col pb-6'>
							<img
							...
							<div className='flex justify-between items-center gap-2 px-4 py-3'>
								<div className='w-12 h-12 bg-white hover:text-white hover:bg-green-600 rounded-full border border-green-600 flex items-center justify-center'>
									<i className='fa-regular fa-heart'></i>
								</div>

								<Link className='flex-1 h-11 rounded-full bg-green-600 flex items-center justify-center text-white font-medium'>
									Add to Cart
								</Link>

								<div className='w-10 h-10 bg-white hover:text-white hover:bg-green-600 rounded-full border border-green-600 flex items-center justify-center'>
									<FaRegEye />
								</div>
							</div>
							...
							<div className='px-4 py-2 text-center'>
								...
								<p className='text-lg font-semibold text-black'>$12.00</p>
								<div className="flex items-center justify-center ">
									<img className='w-[120px]' src="yulduz.svg" alt="yulduz" />
									<p> (524 Feedback)</p>
								</div>
						...
						<div className='group hover:border-[rgba(44,116,47,1)] hover:shadow-[0px_0px_12px_0px_rgba(32,181,38,0.32)] transition-all cursor-pointer bg-[rgba(255,255,255,1)] border-1 border-[rgba(230,230,230,1)]'>
							...
							<img className='w-full' src='meva6.svg' alt='cards img' />
							<div className='p-[12px]'>
								...
								<img className='mt-[6px]' src='yulduz.svg' alt='images' />
							</div>
						</div>
