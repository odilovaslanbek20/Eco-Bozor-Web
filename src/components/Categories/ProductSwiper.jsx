			...
			<section className='max-w-[1320px] m-auto max-[1360px]:mx-[20px] mb-[50px]'>
				<div className=''>
					...
					<div className=''>
						...
						>
							{dataCategories?.products3?.map(card => {
								return (
									<SwiperSlide>
										<Link to='/data'>
											<div
												key={card?.id}
												className='mb-[50px] group hover:border-[rgba(44,116,47,1)] hover:shadow-[0px_0px_12px_0px_rgba(32,181,38,0.32)] transition-all cursor-pointer bg-[rgba(255,255,255,1)] border-1 border-[rgba(230,230,230,1)]'
											>
