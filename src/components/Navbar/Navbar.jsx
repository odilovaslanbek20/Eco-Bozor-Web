	...
	return (
		<>
			<header className='border-b py-[24px] border-[rgba(230,230,230,1)] '>
				...
				<div className='flex items-center justify-between gap-[20px] max-[800px]:flex-col max-[400px]:gap-[10px]'>
					<Link to='/'>
					...
					<div className='flex items-center gap-[16px] min-w-[190px]'>
						<div className=''>
							<i className='fa-regular fa-heart text-[25px] cursor-pointer'></i>
						</div>
						<hr className='w-[1px] h-[25px] bg-[rgba(204,204,204,1)]' />
						<div onClick={() => setModal(true)} className='relative'>
							<HiOutlineShoppingBag className='text-[30px] cursor-pointer' />
							<p className='absolute   text-[rgba(255,255,255,1)] text-[11px] font-["Poppins] font-medium w-[18px] h-[18px] bg-[rgba(0,178,7,1)] mt-[-32px] ml-[16px] rounded-full flex items-center justify-center'>
								0
							</p>
						</div>
						<div onClick={() => setModal(true)} className=''>
							<p className='text-[rgba(77,77,77,1)] font-["Poppins"] font-normal text-[11px]'>
								Shopping cart:
							</p>
							<span className='text-[rgba(77,77,77,1)] font-["Poppins"] font-medium text-[14px]'>
								$57.00
							</span>
						</div>
					</div>
